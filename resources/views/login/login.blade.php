...
<html lang="en" data-bs-theme="blue-theme">
  ...
  <body>
    <!--authentication-->
    <div
      class="auth-basic-wrapper d-flex align-items-center justify-content-center"
    >
      <div class="container-fluid my-5 my-lg-0">
        <div class="row">
          <div class="col-12 col-md-8 col-lg-6 col-xl-5 col-xxl-4 mx-auto">
            <div
              class="card rounded-4 mb-0 border-top border-4 border-primary border-gradient-1"
            >
              <div class="card-body p-5">
                ...
                <h4 class="fw-bold text-center">WELCOME BACK</h4>
                <p class="mb-0 text-center">Please login first</p>
                  ...
                  <form class="row g-3">
                    ...
                    <div class="col-12">
                      <div class="d-grid">
                        ...
                        <a
                          href="dashboard"
                          class="btn btn-grd-primary mt-2"
                          >Masuk Dashboard Langsung</a
                        >
                      </div>
                    </div>
                    <!-- <div class="col-12">
                      <div class="text-start">
                        <p class="mb-0">
                          ...
                          <a href="auth-basic-register.html">Sign up here</a>
                        </p>
                      </div>
                    </div> -->
                  </form>
                ...
                <!-- <div class="separator section-padding">
                  <div class="line"></div>
                  <p class="mb-0 fw-bold">ADMIN CONTACT</p>
                  <div class="line"></div>
                </div>
